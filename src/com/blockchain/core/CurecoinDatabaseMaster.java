...
public class CurecoinDatabaseMaster {
	...
	/**
	 * Attempts to add a block to the blockchain; passthrough to
	...
	/**
	 * Gets a the block at a certain height of the longest chain; passthrough to
	 * Blockchain.getBlock(int blockNum).
	 * 
	 * @param blockNum
	...
	/**
	 * Constructor for CurecoinDatabaseMaster reads in blockchain data, and writes
	 * the first two blocks of the network to a file if necessary.
	 */
	...
	/**
	 * Returns the balance of an address on the Curecoin network. Does not include
	...
	/**
	 * Returns the signature index of an address on the Curecoin network. Does not
	 * account for previous signatures; only blockchain info.
	 * 
	 * @param address
	 *            Address to lookup
	 * 
	...
	/**
	 * Increments signature index by one for the provided address; useful when
	 * creating transactions.
	 * 
	 * @param address
	 *            Address to increment signature index for
	 */
