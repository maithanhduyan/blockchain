...
/**
 * Class handles all networking after a socket is accepted. Delegates work into
 * two separate threads, one for incoming data, and one for outgoing data, so
 * data in one direction doesn't block data in the other.
 */
