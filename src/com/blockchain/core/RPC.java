...
/**
 * The RPC object handles or delegates network communication for all RPC
 * requests. RPC requests are stored in a public class variable, and RPC
 * responses are placed into another public class variable. In the future, a
 * queue system will exist, allowing for high-volume RPC calls. Additionally,
 * the RPC currently provides no security. In the final release, RPC will
 * require authentication. RPC calls are used to send and receive coins, as well
 * as publish blocks.
 */
